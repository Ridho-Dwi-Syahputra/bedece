"""Buat notebook 02x_Finetune_Stage35.ipynb"""
import json
from pathlib import Path

OUT = Path(__file__).parent / "02x_Finetune_Stage35.ipynb"
...
cells = [
  ...
  {"cell_type":"markdown","metadata":{},"source":["## CONFIG — ubah ARCH_KEY sesuai arsitektur yang mau di-fine-tune\n"]},
  {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
  ...
  {"cell_type":"markdown","metadata":{},"source":["## Load fold assignment + terapkan koreksi label\n"]},
  {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
  ...
  {"cell_type":"markdown","metadata":{},"source":["## Load fine-tuning plan — hitung oversampling weight per gambar\n"]},
  {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
  ...
  {"cell_type":"markdown","metadata":{},"source":["## Staging gambar ke disk lokal (hindari bottleneck Drive)\n"]},
  {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
  ...
  {"cell_type":"markdown","metadata":{},"source":["## Dataset + transform + WeightedRandomSampler\n"]},
  {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
  ...
  {"cell_type":"markdown","metadata":{},"source":["## Training loop Stage 3.5 (semua fold)\n"]},
  {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
    "results_per_fold = []\n",
    "\n",
...
print(f"SUKSES: {OUT.name} dibuat ({len(cells)} sel)")
